class ChurchesController < ApplicationController
  ...
  private
    ...
    def church_params
      params.require(:church).permit(:name, :address, :city, :state, :zip, :email, :website, :telephone, :service_time, :pastor, :pastor_email, :fb, :twitter, :instagram, :avatar, :calendly_url, :shorturl, :thankyou, :prayer_chain, :logo,:giving_override,:yt)
    end
end
