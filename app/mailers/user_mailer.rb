class UserMailer < ApplicationMailer
  ...
  def MediaReleaseEmail(subject,message)
    ...
    @church = Church.first
    @message = "<p>Hello.</p>"
    @message += "<p>We have not recieved your MEDIA RELEASE as of today.</p>"
    @message += "<p>Please login to CHURCH2 and click the (RED) MEDIA RELEASE Button To Approve.</p>"
    @message += "<p>This helps us manage our social media presence.</p>"
    @message += "<p>If you have any questions, please call the church office.</p>"
    @message += "<p>Telephone: #{@church.telephone}</p>"
